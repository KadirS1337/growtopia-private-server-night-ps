...
int restartmessagein = 600000; //10min
int worldthreading = 12;
bool Connected = false;
int global_loop_tick = 0;
bool ismathevent = 0;
int matheventanswer = 0;
int matheventnumber1 = 0;
int matheventnumber2 = 0;
int matheventprize = 0;
int loop_world = 0;
...
vector<string> thread_safe_effects{};
vector<string> thread_safe_tileupdate{};
vector<string> thread_safe_seedupdate{};
vector<string> thread_safe_magupdate{};
vector<string> thread_safe_punchupdate{};
...
inline string stringtolower(std::string str)
{
	std::transform(str.begin(), str.end(), str.begin(), ::tolower);
	return str;
}
inline string stringtoupper(std::string str)
{
	std::transform(str.begin(), str.end(), str.begin(), ::toupper);
	return str;
}

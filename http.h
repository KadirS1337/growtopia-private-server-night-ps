...
void http::run(int port, string ip, int w_port) {
	...
	if (!http_server) {
		...
		SendConsole("HTTP servisi basladi, oyuncu portu: " + http_ip + ":" + http_port, "HTTP");
	} while (true) {
